...
const COMMON_CSR_REGISTERS: &[CsrRegister] = &[
    ...
    CsrRegister::new("time", Some(126)),
    CsrRegister::new("mhartid", Some(127)),
    ...
    CsrRegister::new("vl", Some(132)),
    CsrRegister::new("vtype", Some(133)),
    CsrRegister::new("vlenb", Some(134)),
    CsrRegister::new("senvcfg", Some(135)),
    CsrRegister::new("pmpcfg0", Some(136)),
    CsrRegister::new("pmpaddr0", Some(137)),
    CsrRegister::new("mcycle", Some(138)),
    CsrRegister::new("minstret", Some(139)),
    CsrRegister::new("pmpaddr1", Some(140)),
    CsrRegister::new("pmpaddr2", Some(141)),
    CsrRegister::new("pmpaddr3", Some(142)),
    CsrRegister::new("pmpaddr4", Some(143)),
