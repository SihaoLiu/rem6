...
const SUPPORTED_INDEXED_M1_SHAPES: &[(MemoryWidth, MemoryWidth, &[usize], usize)] = &[
    ...
    (MemoryWidth::Byte, MemoryWidth::Doubleword, &[0, 15], 16),
    (MemoryWidth::Halfword, MemoryWidth::Byte, &[0, 14], 16),
    ...
    (MemoryWidth::Word, MemoryWidth::Byte, &[0, 12], 16),
    (MemoryWidth::Word, MemoryWidth::Halfword, &[0, 12], 16),
    (MemoryWidth::Word, MemoryWidth::Word, &[0, 12], 16),
    (MemoryWidth::Word, MemoryWidth::Doubleword, &[0, 12], 16),
    (MemoryWidth::Word, MemoryWidth::Word, &[4, 12], 16),
    (MemoryWidth::Word, MemoryWidth::Word, &[12, 0], 16),
    (MemoryWidth::Doubleword, MemoryWidth::Byte, &[0, 8], 16),
    (MemoryWidth::Doubleword, MemoryWidth::Halfword, &[0, 8], 16),
    (MemoryWidth::Doubleword, MemoryWidth::Word, &[0, 8], 16),
    (
    ...
    (MemoryWidth::Doubleword, MemoryWidth::Byte, &[0, 24], 32),
    (MemoryWidth::Doubleword, MemoryWidth::Halfword, &[0, 24], 32),
    (
        MemoryWidth::Doubleword,
        MemoryWidth::Doubleword,
        &[0, 24],
