...
pub enum RiscvVectorFloatInstruction {
    ...
    ConvertFloatFromUnsignedIntV {
        vd: VectorRegister,
        vs2: VectorRegister,
    },
    ConvertFloatFromSignedIntV {
        vd: VectorRegister,
        vs2: VectorRegister,
    },
    ...
    ConvertUnsignedIntFromFloatTowardZeroV {
        vd: VectorRegister,
        vs2: VectorRegister,
    },
    ConvertSignedIntFromFloatTowardZeroV {
        vd: VectorRegister,
        vs2: VectorRegister,
    },
    SignInjectVv {
...
impl RiscvVectorNarrowInstruction {
    ...
    pub const fn shift_right_logical_wx(
        vd: VectorRegister,
        vs2: VectorRegister,
        rs1: Register,
    ) -> Self {
    ...
    pub const fn shift_right_arithmetic_wx(
        vd: VectorRegister,
        vs2: VectorRegister,
        rs1: Register,
    ) -> Self {
    ...
    pub const fn vd(self) -> VectorRegister {
        match self {
            Self::Wv { vd, .. } | Self::Wx { vd, .. } | Self::Wi { vd, .. } => vd,
        }
    }

    pub const fn vs2(self) -> VectorRegister {
        match self {
            Self::Wv { vs2, .. } | Self::Wx { vs2, .. } | Self::Wi { vs2, .. } => vs2,
        }
    }
    ...
    pub const fn vs1(self) -> Option<VectorRegister> {
        match self {
            ...
            Self::Wx { .. } | Self::Wi { .. } => None,
        }
    }

    pub const fn rs1(self) -> Option<Register> {
        match self {
            Self::Wx { rs1, .. } => Some(rs1),
            Self::Wv { .. } | Self::Wi { .. } => None,
        }
    }
