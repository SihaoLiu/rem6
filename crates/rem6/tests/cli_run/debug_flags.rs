...
#[path = "debug_flags/host_action.rs"]
mod host_action;
#[path = "debug_flags/o3_checkpoint_restore.rs"]
mod o3_checkpoint_restore;
#[path = "debug_flags/o3_fu_latency.rs"]
mod o3_fu_latency;
#[path = "debug_flags/o3_lsq_operations.rs"]
mod o3_lsq_operations;
#[path = "debug_flags/o3_store_forwarding.rs"]
