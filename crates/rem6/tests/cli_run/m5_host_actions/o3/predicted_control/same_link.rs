use super::window_support::{
    ...
    assert_no_data_address, assert_no_fetch_pc, assert_ordered_commits,
    assert_register_absent_or_zero, assert_stopped_by_host, fetch_count_at_pc, fetch_tick_at_pc,
