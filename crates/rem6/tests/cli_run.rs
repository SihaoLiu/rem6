#[path = "cli_run/accelerator.rs"]
mod accelerator;
#[path = "cli_run/cache_prefetch.rs"]
mod cache_prefetch;
#[path = "cli_run/checker_cpu.rs"]
mod checker_cpu;
...
mod m5_host_actions;
#[path = "cli_run/m5_periodic_checkpoint.rs"]
...
#[path = "cli_run/riscv_se_ioctl.rs"]
mod riscv_se_ioctl;
...
#[path = "cli_run/riscv_se_pidfd.rs"]
mod riscv_se_pidfd;
...
mod riscv_se_riscv;
#[path = "cli_run/riscv_se_sched_attr.rs"]
mod riscv_se_sched_attr;
