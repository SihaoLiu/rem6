...
impl Rem6DramSummary {
    ...
    fn from_profile(profile: DramMemoryActivityProfile) -> Self {
        ...
        Self {
            ...
            profile_timing_refresh_granularity: timing.and_then(|timing| {
                timing
                    .refresh_timing()
                    .map(|refresh| refresh.granularity().as_str())
            }),
...
impl Rem6DramBankSummary {
    fn from_activity(bank: u32, activity: &DramBankActivity) -> Self {
        Self {
            ...
            read_row_hits: activity.read_row_hit_count() as u64,
            write_row_hits: activity.write_row_hit_count() as u64,
