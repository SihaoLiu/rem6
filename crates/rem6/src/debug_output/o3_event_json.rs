...
pub(super) fn o3_event_to_json(event: &O3RuntimeTraceRecord) -> String {
    ...
    format!(
        ...
        event.store_load_forwarding_partial(),
        event.store_load_forwarding_bytes(),
