...
pub(crate) use host_actions::{
    ...
    Rem6HostO3RuntimeCheckpointChunkSummary, Rem6HostStatsDumpSampleSummary,
...
pub struct Rem6DramSummary {
    ...
    profile_timing_refresh_policy: Option<&'static str>,
    profile_timing_refresh_granularity: Option<&'static str>,
...
fn execute_riscv(
    ...
    let host_actions = {
        ...
        host_actions::host_action_summary(&controller).map_err(execute_error)?
    };
