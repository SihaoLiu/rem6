...
pub(crate) struct Rem6HostO3RuntimeCheckpointChunkSummary {
    ...
    pub(crate) stats_writeback_port_cycles: Option<u64>,
    pub(crate) stats_writeback_port_admitted_rows: Option<u64>,
    pub(crate) stats_writeback_port_deferred_rows: Option<u64>,
    pub(crate) stats_writeback_port_deferred_row_cycles: Option<u64>,
    pub(crate) stats_writeback_port_max_ready_rows_per_cycle: Option<u64>,
    pub(crate) stats_writeback_port_max_deferred_rows: Option<u64>,
...
impl Rem6HostO3RuntimeCheckpointChunkSummary {
    fn decode_error() -> Self {
        Self {
            ...
            stats_writeback_port_cycles: None,
            stats_writeback_port_admitted_rows: None,
            stats_writeback_port_deferred_rows: None,
            stats_writeback_port_deferred_row_cycles: None,
            stats_writeback_port_max_ready_rows_per_cycle: None,
            stats_writeback_port_max_deferred_rows: None,
    ...
    pub(crate) fn numeric_fields(&self) -> Vec<(&'static str, Option<u64>)> {
        vec![
            ...
            (
                ...
                self.stats_writeback_port_cycles,
            ),
            (
                "stats_writeback_port_admitted_rows",
                self.stats_writeback_port_admitted_rows,
            ),
            (
                "stats_writeback_port_deferred_rows",
                self.stats_writeback_port_deferred_rows,
            ),
            (
                "stats_writeback_port_deferred_row_cycles",
                self.stats_writeback_port_deferred_row_cycles,
            ),
            (
                "stats_writeback_port_max_ready_rows_per_cycle",
                self.stats_writeback_port_max_ready_rows_per_cycle,
            ),
            (
                "stats_writeback_port_max_deferred_rows",
                self.stats_writeback_port_max_deferred_rows,
            ),
