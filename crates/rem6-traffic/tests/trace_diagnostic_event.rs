...
fn trace_generator_emits_print_req_diagnostic_events() {
    ...
    assert!(print_without_probe.is_request());
...
#[test]
fn trace_diagnostic_kind_preserves_gem5_request_print_policy() {
    assert!(
        TrafficTraceDiagnosticKind::Print.is_request(),
