...
pub enum TrafficGeneratorError {
    ...
    TraceCacheEventSizeMismatch {
        command: &'static str,
        size: u64,
        line_size: u64,
    },
    TraceCacheEventUnalignedAddress {
        command: &'static str,
        address: Address,
        line_size: u64,
    },
...
impl fmt::Display for TrafficGeneratorError {
    fn fmt(&self, formatter: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            Self::TraceCacheEventSizeMismatch {
                command,
                size,
                line_size,
            } => write!(
            ...
            Self::TraceCacheEventUnalignedAddress {
                command,
                address,
                line_size,
            } => write!(
            ...
            Self::TraceUpgradeUnalignedAddress {
                command,
                address,
                line_size,
            } => write!(
