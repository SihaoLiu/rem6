...
pub use controller::{
    ...
    TrafficTraceControlFailure, TrafficTraceControlFailureRecord, TrafficTraceControlFailureSource,
    TrafficTraceErrorMatch, TrafficTraceMemoryCompletion, TrafficTraceMemoryFailure,
    TrafficTraceMemoryFailureRecord, TrafficTraceMemoryResponseRecord,
    TrafficTraceMemoryWriteCompletion, TrafficTraceMemoryWriteCompletionRecord,
