...
fn workload_replay_plan_rejects_underreported_typed_sideband_summary() {
    ...
    assert_eq!(
        error.to_string(),
        "traffic trace replay summary for route trace.sideband has scheduled 4/4, responses 0/0, trace completed responses 0/0, trace retry responses 0/0, trace store-conditional failed responses 0/0, trace read responses 0/0, trace write responses 0/0, trace prefetch responses 0/0, trace invalidate responses 0/0, trace clean responses 0/0, trace upgrade responses 0/0, trace llsc responses 0/0, trace locked-rmw responses 0/0, trace writable-intent responses 0/0, trace response data bytes 0/0, trace response fill data bytes 0/0, memory trace events 0/0, memory write completions 0/0, trace data-cache responses 0/0, trace data-cache maintenance responses 0/0, trace data-cache clean maintenance responses 0/0, trace data-cache invalidate maintenance responses 0/0, trace data-cache errors 0/0, trace data-cache invalid-destination errors 0/0, trace data-cache bad-address errors 0/0, trace data-cache read errors 0/0, trace data-cache write errors 0/0, trace data-cache functional-read errors 0/0, trace data-cache functional-write errors 0/0, memory failures 0/0, memory failure invalid destinations 0/0, memory failure bad addresses 0/0, memory failure reads 0/0, memory failure writes 0/0, memory failure functional reads 0/0, memory failure functional writes 0/0, trace errors 0/0, trace invalid-destination errors 0/0, trace bad-address errors 0/0, trace read errors 0/0, trace write errors 0/0, trace functional-read errors 0/0, trace functional-write errors 0/0, trace htm accesses 0/0, trace htm begins 0/0, control acks 0/0, sync control acks 0/0, htm control acks 0/0, control failures 0/0, control failure invalid destinations 0/0, control failure bad addresses 0/0, control failure reads 0/0, control failure writes 0/0, control failure functional reads 0/0, control failure functional writes 0/0, sync control failures 0/0, tlb control failures 0/0, cache control failures 0/0, htm control failures 0/0, diagnostic control failures 0/0, sideband events 4/4, trace sideband failures 0/0, tlb sync events 1/1, trace tlb syncs 0/1, cache flush events 0/1, trace cache flushes 0/1, trace cache flush data bytes 0/0, trace l1 invalidations 0/1, diagnostic print events 0/0, trace diagnostics 0/1, htm abort events 0/0, trace htm aborts 0/1",
    );
}
...
fn workload_replay_plan_rejects_underreported_trace_data_cache_response_summary() {
    ...
    assert_eq!(
        error.to_string(),
        "traffic trace replay summary for route trace.cache has scheduled 2/0, responses 2/2, trace completed responses 0/0, trace retry responses 0/0, trace store-conditional failed responses 0/0, trace read responses 0/0, trace write responses 0/0, trace prefetch responses 0/0, trace invalidate responses 0/0, trace clean responses 0/0, trace upgrade responses 0/0, trace llsc responses 0/0, trace locked-rmw responses 0/0, trace writable-intent responses 0/0, trace response data bytes 0/0, trace response fill data bytes 0/0, memory trace events 0/0, memory write completions 0/0, trace data-cache responses 1/2, trace data-cache maintenance responses 0/0, trace data-cache clean maintenance responses 0/0, trace data-cache invalidate maintenance responses 0/0, trace data-cache errors 0/0, trace data-cache invalid-destination errors 0/0, trace data-cache bad-address errors 0/0, trace data-cache read errors 0/0, trace data-cache write errors 0/0, trace data-cache functional-read errors 0/0, trace data-cache functional-write errors 0/0, memory failures 0/0, memory failure invalid destinations 0/0, memory failure bad addresses 0/0, memory failure reads 0/0, memory failure writes 0/0, memory failure functional reads 0/0, memory failure functional writes 0/0, trace errors 0/0, trace invalid-destination errors 0/0, trace bad-address errors 0/0, trace read errors 0/0, trace write errors 0/0, trace functional-read errors 0/0, trace functional-write errors 0/0, trace htm accesses 0/0, trace htm begins 0/0, control acks 0/0, sync control acks 0/0, htm control acks 0/0, control failures 0/0, control failure invalid destinations 0/0, control failure bad addresses 0/0, control failure reads 0/0, control failure writes 0/0, control failure functional reads 0/0, control failure functional writes 0/0, sync control failures 0/0, tlb control failures 0/0, cache control failures 0/0, htm control failures 0/0, diagnostic control failures 0/0, sideband events 0/0, trace sideband failures 0/0, tlb sync events 0/0, trace tlb syncs 0/0, cache flush events 0/0, trace cache flushes 0/0, trace cache flush data bytes 0/0, trace l1 invalidations 0/0, diagnostic print events 0/0, trace diagnostics 0/0, htm abort events 0/0, trace htm aborts 0/0",
    );
}
...
fn workload_replay_plan_rejects_underreported_trace_error_summary() {
    ...
    assert_eq!(
        error.to_string(),
        "traffic trace replay summary for route trace.error has scheduled 1/0, responses 0/0, trace completed responses 0/0, trace retry responses 0/0, trace store-conditional failed responses 0/0, trace read responses 0/0, trace write responses 0/0, trace prefetch responses 0/0, trace invalidate responses 0/0, trace clean responses 0/0, trace upgrade responses 0/0, trace llsc responses 0/0, trace locked-rmw responses 0/0, trace writable-intent responses 0/0, trace response data bytes 0/0, trace response fill data bytes 0/0, memory trace events 0/0, memory write completions 0/0, trace data-cache responses 0/0, trace data-cache maintenance responses 0/0, trace data-cache clean maintenance responses 0/0, trace data-cache invalidate maintenance responses 0/0, trace data-cache errors 0/0, trace data-cache invalid-destination errors 0/0, trace data-cache bad-address errors 0/0, trace data-cache read errors 0/0, trace data-cache write errors 0/0, trace data-cache functional-read errors 0/0, trace data-cache functional-write errors 0/0, memory failures 1/1, memory failure invalid destinations 0/0, memory failure bad addresses 0/0, memory failure reads 0/0, memory failure writes 0/0, memory failure functional reads 0/0, memory failure functional writes 0/0, trace errors 0/1, trace invalid-destination errors 0/0, trace bad-address errors 0/0, trace read errors 0/0, trace write errors 0/0, trace functional-read errors 0/0, trace functional-write errors 0/0, trace htm accesses 0/0, trace htm begins 0/0, control acks 0/0, sync control acks 0/0, htm control acks 0/0, control failures 0/0, control failure invalid destinations 0/0, control failure bad addresses 0/0, control failure reads 0/0, control failure writes 0/0, control failure functional reads 0/0, control failure functional writes 0/0, sync control failures 0/0, tlb control failures 0/0, cache control failures 0/0, htm control failures 0/0, diagnostic control failures 0/0, sideband events 0/0, trace sideband failures 0/0, tlb sync events 0/0, trace tlb syncs 0/0, cache flush events 0/0, trace cache flushes 0/0, trace cache flush data bytes 0/0, trace l1 invalidations 0/0, diagnostic print events 0/0, trace diagnostics 0/0, htm abort events 0/0, trace htm aborts 0/0",
    );
}
...
fn workload_replay_plan_rejects_underreported_trace_htm_access_summary() {
    ...
    assert_eq!(
        error.to_string(),
        "traffic trace replay summary for route trace.htm has scheduled 3/0, responses 2/2, trace completed responses 0/0, trace retry responses 0/0, trace store-conditional failed responses 0/0, trace read responses 0/0, trace write responses 0/0, trace prefetch responses 0/0, trace invalidate responses 0/0, trace clean responses 0/0, trace upgrade responses 0/0, trace llsc responses 0/0, trace locked-rmw responses 0/0, trace writable-intent responses 0/0, trace response data bytes 0/0, trace response fill data bytes 0/0, memory trace events 0/0, memory write completions 0/0, trace data-cache responses 0/0, trace data-cache maintenance responses 0/0, trace data-cache clean maintenance responses 0/0, trace data-cache invalidate maintenance responses 0/0, trace data-cache errors 0/0, trace data-cache invalid-destination errors 0/0, trace data-cache bad-address errors 0/0, trace data-cache read errors 0/0, trace data-cache write errors 0/0, trace data-cache functional-read errors 0/0, trace data-cache functional-write errors 0/0, memory failures 0/0, memory failure invalid destinations 0/0, memory failure bad addresses 0/0, memory failure reads 0/0, memory failure writes 0/0, memory failure functional reads 0/0, memory failure functional writes 0/0, trace errors 0/0, trace invalid-destination errors 0/0, trace bad-address errors 0/0, trace read errors 0/0, trace write errors 0/0, trace functional-read errors 0/0, trace functional-write errors 0/0, trace htm accesses 0/2, trace htm begins 0/0, control acks 0/0, sync control acks 0/0, htm control acks 0/0, control failures 0/0, control failure invalid destinations 0/0, control failure bad addresses 0/0, control failure reads 0/0, control failure writes 0/0, control failure functional reads 0/0, control failure functional writes 0/0, sync control failures 0/0, tlb control failures 0/0, cache control failures 0/0, htm control failures 0/0, diagnostic control failures 0/0, sideband events 0/0, trace sideband failures 0/0, tlb sync events 0/0, trace tlb syncs 0/0, cache flush events 0/0, trace cache flushes 0/0, trace cache flush data bytes 0/0, trace l1 invalidations 0/0, diagnostic print events 0/0, trace diagnostics 0/0, htm abort events 0/0, trace htm aborts 0/0",
    );
}
