...
pub struct WorkloadTrafficTraceReplaySummary {
    ...
    pub(in crate::traffic_trace_replay) trace_invalidate_response_count: usize,
    pub(in crate::traffic_trace_replay) trace_clean_response_count: usize,
    ...
    pub(in crate::traffic_trace_replay) trace_error_invalid_destination_count: usize,
    pub(in crate::traffic_trace_replay) trace_error_bad_address_count: usize,
    pub(in crate::traffic_trace_replay) trace_error_read_count: usize,
    pub(in crate::traffic_trace_replay) trace_error_write_count: usize,
    pub(in crate::traffic_trace_replay) trace_error_functional_read_count: usize,
    pub(in crate::traffic_trace_replay) trace_error_functional_write_count: usize,
...
impl WorkloadTrafficTraceReplaySummary {
    pub fn new(route: WorkloadRouteId, scheduled_count: usize) -> Self {
        Self {
            ...
            trace_invalidate_response_count: 0,
            trace_clean_response_count: 0,
            ...
            trace_error_count: 0,
            trace_error_invalid_destination_count: 0,
            trace_error_bad_address_count: 0,
            trace_error_read_count: 0,
            trace_error_write_count: 0,
            trace_error_functional_read_count: 0,
            trace_error_functional_write_count: 0,
...
impl WorkloadExpectedTrafficTraceReplaySummary {
    pub fn new(route: WorkloadRouteId) -> Self {
        Self {
            ...
            minimum_trace_invalidate_response_count: 0,
            minimum_trace_clean_response_count: 0,
            ...
            minimum_trace_error_invalid_destination_count: 0,
            minimum_trace_error_bad_address_count: 0,
            minimum_trace_error_read_count: 0,
            minimum_trace_error_write_count: 0,
            minimum_trace_error_functional_read_count: 0,
            minimum_trace_error_functional_write_count: 0,
