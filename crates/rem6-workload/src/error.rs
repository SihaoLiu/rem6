...
pub use large_payload::{
    WorkloadCheckpointComponentChunkSummaryBelowMinimumError, WorkloadCheckpointSummaryTimingError,
...
pub enum WorkloadError {
    ...
    CheckpointManifestSummaryAfterFinalTick(Box<WorkloadCheckpointSummaryTimingError>),
    ...
    InvalidParallelRemoteTrafficFlowEndpoints {
        scope: WorkloadParallelRemoteFlowScope,
        source: u32,
        target: u32,
        send_count: usize,
    ...
    InvalidParallelRemoteTrafficFlowTiming {
        scope: WorkloadParallelRemoteFlowScope,
        source: u32,
        target: u32,
        send_count: usize,
    ...
    InvalidParallelRemoteTrafficFlowDelayBounds {
        scope: WorkloadParallelRemoteFlowScope,
        source: u32,
        target: u32,
        minimum_delay: Tick,
    ...
    MissingParallelRemoteTrafficAggregateFlow {
        ...
        source: u32,
        target: u32,
        send_record_count: usize,
        send_first_tick: Tick,
        send_last_tick: Tick,
        send_minimum_delay: Tick,
        send_maximum_delay: Tick,
    },
    ...
    InvalidParallelFrontierMergeSummary {
        scope: WorkloadParallelSchedulerScope,
        stage: WorkloadParallelFrontierStage,
        partition: u32,
        merged_now: Option<Tick>,
        scoped_now: Tick,
        merged_safe_until: Option<Tick>,
        scoped_safe_until: Tick,
        merged_next_tick: Option<Tick>,
        scoped_next_tick: Option<Tick>,
        merged_pending_events: Option<usize>,
        scoped_pending_events: usize,
    },
    ...
    UnexpectedParallelBatchWorkerCount {
        scope: WorkloadParallelBatchWorkerScope,
        worker_count: usize,
        batch_count: usize,
    },
    ...
    InvalidParallelWaitForEdgeKindCountMergeSummary {
        scope: WorkloadParallelDiagnosticScope,
        kind: WaitForEdgeKind,
    ...
    InvalidParallelWaitForBlockedNodeWindowMergeSummary {
        scope: WorkloadParallelDiagnosticScope,
        node: WaitForNode,
        merged_edge_count: usize,
        scoped_edge_count: usize,
    ...
    InvalidParallelWaitForTargetNodeWindowMergeSummary {
        scope: WorkloadParallelDiagnosticScope,
        node: WaitForNode,
        merged_edge_count: usize,
        scoped_edge_count: usize,
