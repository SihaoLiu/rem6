...
impl fmt::Display for WorkloadError {
    fn fmt(&self, formatter: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            | Self::UnexpectedParallelBatchWorkerTickSummary { .. }
            ...
            | Self::InvalidParallelBatchTimelineMergeSummary { .. }
            ...
            Self::PlannedParallelBatchWorkerSlotExpectation(error) => {
                write!(formatter, "{error}")
            }
            Self::PlannedParallelBatchWorkerLanePartitionExpectation(error) => {
                write!(formatter, "{error}")
            }
            ...
            | Self::InvalidParallelWaitForEdgeKindCountMergeSummary { .. }
