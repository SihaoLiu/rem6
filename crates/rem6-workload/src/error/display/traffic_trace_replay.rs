    ...
    match error {
        ...
        WorkloadError::TrafficTraceReplaySummaryExpectation(error) => match error.as_ref() {
            WorkloadTrafficTraceReplaySummaryExpectationError::Missing(expected) => write!(
                formatter,
                "traffic trace replay summary for route {} was not recorded; expected scheduled {}, responses {}, trace completed responses {}, trace retry responses {}, trace store-conditional failed responses {}, trace read responses {}, trace write responses {}, trace prefetch responses {}, trace invalidate responses {}, trace clean responses {}, trace upgrade responses {}, trace llsc responses {}, trace locked-rmw responses {}, trace writable-intent responses {}, trace response data bytes {}, trace response fill data bytes {}, memory trace events {}, memory write completions {}, trace data-cache responses {}, trace data-cache maintenance responses {}, trace data-cache clean maintenance responses {}, trace data-cache invalidate maintenance responses {}, trace data-cache errors {}, trace data-cache invalid-destination errors {}, trace data-cache bad-address errors {}, trace data-cache read errors {}, trace data-cache write errors {}, trace data-cache functional-read errors {}, trace data-cache functional-write errors {}, memory failures {}, memory failure invalid destinations {}, memory failure bad addresses {}, memory failure reads {}, memory failure writes {}, memory failure functional reads {}, memory failure functional writes {}, trace errors {}, trace invalid-destination errors {}, trace bad-address errors {}, trace read errors {}, trace write errors {}, trace functional-read errors {}, trace functional-write errors {}, trace htm accesses {}, trace htm begins {}, control acks {}, sync control acks {}, htm control acks {}, control failures {}, control failure invalid destinations {}, control failure bad addresses {}, control failure reads {}, control failure writes {}, control failure functional reads {}, control failure functional writes {}, sync control failures {}, tlb control failures {}, cache control failures {}, htm control failures {}, diagnostic control failures {}, sideband events {}, trace sideband failures {}, tlb sync events {}, trace tlb syncs {}, cache flush events {}, trace cache flushes {}, trace cache flush data bytes {}, trace l1 invalidations {}, diagnostic print events {}, trace diagnostics {}, htm abort events {}, trace htm aborts {}",
