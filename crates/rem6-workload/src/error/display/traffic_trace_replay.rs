    ...
    match error {
        ...
        WorkloadError::TrafficTraceReplaySummaryExpectation(error) => match error.as_ref() {
            WorkloadTrafficTraceReplaySummaryExpectationError::Missing(expected) => write!(
                formatter,
                "traffic trace replay summary for route {} was not recorded; expected scheduled {}, responses {}, memory trace events {}, memory failures {}, control acks {}, control failures {}, sideband events {}",
            ...
            WorkloadTrafficTraceReplaySummaryExpectationError::BelowMinimum {
                ...
                formatter,
                "traffic trace replay summary for route {} has scheduled {}/{}, responses {}/{}, memory trace events {}/{}, memory failures {}/{}, control acks {}/{}, control failures {}/{}, sideband events {}/{}",
                expected.route().as_str(),
