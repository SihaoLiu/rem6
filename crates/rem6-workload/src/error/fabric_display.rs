...
pub(super) fn format_fabric_activity_error(
    ...
    match error {
        ...
        WorkloadError::ExpectedFabricHopActivityBelowMinimum(activity) => write!(
            formatter,
            "expected fabric hop {} on link {} virtual network {} activity to reach at least {} transfers, {} bytes, {} occupied ticks, {} queue delay ticks, first tick {}, and last tick {}, got {} transfers, {} bytes, {} occupied ticks, {} queue delay ticks, first tick {}, and last tick {}",
            activity.hop_index,
            activity.link.as_str(),
            activity.virtual_network.get(),
            activity.minimum_transfer_count,
            activity.minimum_byte_count,
            activity.minimum_occupied_ticks,
            activity.minimum_queue_delay_ticks,
            format_optional_tick(&activity.required_first_tick),
            format_optional_tick(&activity.required_last_tick),
            activity.actual_transfer_count,
            activity.actual_byte_count,
            activity.actual_occupied_ticks,
            activity.actual_queue_delay_ticks,
            activity.actual_first_tick,
            activity.actual_last_tick
        ),
        ...
        WorkloadError::ExpectedFabricLaneActivityBelowMinimum(activity) => write!(
            formatter,
            "expected fabric lane {} virtual network {} activity to reach at least {} transfers, {} bytes, {} occupied ticks, {} queue delay ticks, maximum queue delay {}, first tick {}, and last tick {}, got {} transfers, {} bytes, {} occupied ticks, {} queue delay ticks, maximum queue delay {}, first tick {}, and last tick {}",
            activity.link.as_str(),
            activity.virtual_network.get(),
            activity.minimum_transfer_count,
            activity.minimum_byte_count,
            activity.minimum_occupied_ticks,
            activity.minimum_queue_delay_ticks,
            activity.minimum_max_queue_delay_ticks,
            format_optional_tick(&activity.required_first_tick),
            format_optional_tick(&activity.required_last_tick),
            activity.actual_transfer_count,
            activity.actual_byte_count,
            activity.actual_occupied_ticks,
            activity.actual_queue_delay_ticks,
            activity.actual_max_queue_delay_ticks,
            activity.actual_first_tick,
            activity.actual_last_tick
        ),
        ...
        WorkloadError::ExpectedFabricLinkActivityBelowMinimum(activity) => write!(
            formatter,
            "expected fabric link {} activity to reach at least {} transfers, {} active virtual networks, {} queue delay ticks, {} contended virtual networks, first tick {}, and last tick {}, got {} transfers, {} active virtual networks, {} queue delay ticks, {} contended virtual networks, first tick {}, and last tick {}",
            activity.link.as_str(),
            activity.minimum_transfer_count,
            activity.minimum_active_virtual_network_count,
            activity.minimum_queue_delay_ticks,
            activity.minimum_contended_virtual_network_count,
            format_optional_tick(&activity.required_first_tick),
            format_optional_tick(&activity.required_last_tick),
            activity.actual_transfer_count,
            activity.actual_active_virtual_network_count,
            activity.actual_queue_delay_ticks,
            activity.actual_contended_virtual_network_count,
            activity.actual_first_tick,
            activity.actual_last_tick
        ),
