...
pub struct WorkloadParallelExecutionSummary {
    ...
    raw_full_system_parallel_scheduler_batch_worker_count_ticks: Vec<(usize, Tick)>,
    full_system_parallel_scheduler_batch_worker_count_ticks: Vec<(usize, Tick)>,
    raw_full_system_parallel_scheduler_batch_worker_tick_streaks: Vec<(usize, Tick)>,
    ...
    raw_full_system_wait_for_edge_kind_windows: Vec<WorkloadWaitForEdgeKindWindow>,
    full_system_wait_for_edge_kind_windows: Vec<WorkloadWaitForEdgeKindWindow>,
    raw_full_system_wait_for_blocked_node_windows: Vec<WorkloadWaitForBlockedNodeWindow>,
    full_system_wait_for_blocked_node_windows: Vec<WorkloadWaitForBlockedNodeWindow>,
    raw_full_system_wait_for_target_node_windows: Vec<WorkloadWaitForTargetNodeWindow>,
    ...
    gpu_dma_scheduler_progress_transitions: Vec<ParallelProgressTransitionRecord>,
    ...
    accelerator_dma_scheduler_progress_transitions: Vec<ParallelProgressTransitionRecord>,
...
impl WorkloadParallelExecutionSummary {
    ...
    pub fn with_full_system_parallel_scheduler_partition_activities(
        mut self,
        activities: impl IntoIterator<Item = (PartitionId, ParallelPartitionActivity)>,
    ) -> Self {
