...
pub(crate) fn format_remote_delay_error(
    ...
    match error {
        ...
        WorkloadError::InvalidParallelRemoteFlowMergeSummary(summary) => write!(
            formatter,
            "invalid {} remote flow {}->{} merge summary: merged count {}, ticks {} to {}, delay {} to {}; scoped count {}, ticks {} to {}, delay {} to {}",
            summary.scope.as_str(),
            summary.source,
            summary.target,
            summary.merged_send_count,
            format_optional_tick(summary.merged_first_tick),
            format_optional_tick(summary.merged_last_tick),
            format_optional_tick(summary.merged_minimum_delay),
            format_optional_tick(summary.merged_maximum_delay),
            summary.scoped_send_count,
            summary.scoped_first_tick,
            summary.scoped_last_tick,
            format_optional_tick(summary.scoped_minimum_delay),
            format_optional_tick(summary.scoped_maximum_delay)
        ),
