...
fn traffic_trace_replay_summary_meets_minimum(
    ...
    actual.scheduled_count() >= expected.minimum_scheduled_count()
        ...
        && actual.trace_clean_response_count() >= expected.minimum_trace_clean_response_count()
        ...
        && actual.trace_error_invalid_destination_count()
            >= expected.minimum_trace_error_invalid_destination_count()
        && actual.trace_error_bad_address_count()
            >= expected.minimum_trace_error_bad_address_count()
        && actual.trace_error_read_count() >= expected.minimum_trace_error_read_count()
        && actual.trace_error_write_count() >= expected.minimum_trace_error_write_count()
        && actual.trace_error_functional_read_count()
            >= expected.minimum_trace_error_functional_read_count()
        && actual.trace_error_functional_write_count()
            >= expected.minimum_trace_error_functional_write_count()
