...
pub use crate::riscv_defaults::{
    ...
    DEFAULT_RISCV_O3_WRITEBACK_WIDTH, MAX_RISCV_O3_ISSUE_WIDTH, MAX_RISCV_O3_MEMORY_ISSUE_WIDTH,
    MAX_RISCV_O3_WRITEBACK_WIDTH, MIN_RISCV_O3_ISSUE_WIDTH, MIN_RISCV_O3_MEMORY_ISSUE_WIDTH,
