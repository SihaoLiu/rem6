...
mod tests {
    ...
    fn o3_writeback_width_defaults_to_one_and_rejects_out_of_range_updates() {
        use crate::o3_pipeline::{
            O3DependencyScopeId, O3IssueOpClass, O3IssueQueueId, O3PendingStateSnapshot,
            O3PipelineStage, O3ScopedReadyInstruction, O3WritebackCompletion,
            O3WritebackTransferPolicy, O3WritebackTransferSnapshot,
        };
        use crate::riscv_defaults::DEFAULT_RISCV_O3_WRITEBACK_WIDTH;
