...
pub use ide::{
    ...
    IdeDeviceId, IDE_ALTSTAT_OFFSET, IDE_BMI_CHANNEL_BYTES, IDE_BMI_COMMAND_OFFSET,
    IDE_BMI_COMMAND_RW, IDE_BMI_COMMAND_START, IDE_BMI_PRD_TABLE_OFFSET, IDE_BMI_STATUS_ACTIVE,
    IDE_BMI_STATUS_DMA_CAP0, IDE_BMI_STATUS_DMA_CAP1, IDE_BMI_STATUS_DMA_ERROR,
    IDE_BMI_STATUS_INTERRUPT, IDE_BMI_STATUS_OFFSET, IDE_COMMAND_ATAPI_IDENTIFY_DEVICE,
    IDE_COMMAND_IDENTIFY, IDE_COMMAND_OFFSET, IDE_COMMAND_READ, IDE_COMMAND_READ_DMA,
    IDE_COMMAND_READ_MULTI, IDE_COMMAND_READ_NATIVE_MAX, IDE_COMMAND_WRITE, IDE_COMMAND_WRITE_DMA,
    IDE_COMMAND_WRITE_MULTI, IDE_CONTROL_IEN, IDE_CONTROL_OFFSET, IDE_CONTROL_RST, IDE_DATA_OFFSET,
    IDE_DRIVE_DEVICE1, IDE_DRIVE_LBA, IDE_DRIVE_OFFSET, IDE_ERROR_ABORT, IDE_ERROR_OFFSET,
    IDE_FEATURES_OFFSET, IDE_HCYL_OFFSET, IDE_LCYL_OFFSET, IDE_NSECTOR_OFFSET, IDE_SECTOR_OFFSET,
    IDE_STATUS_BSY, IDE_STATUS_DF, IDE_STATUS_DRDY, IDE_STATUS_DRQ, IDE_STATUS_ERR,
    IDE_STATUS_OFFSET, IDE_STATUS_SEEK,
};
pub use ide_disk::{IdeCommandIssue, IdeDisk};
pub(crate) use ide_disk::{IdeDataReadIssue, IdeDataWriteIssue};
