...
pub(super) struct RiscvO3RuntimeBranchDirectionMismatchStats {
    pub(super) mismatches: StatId,
    pub(super) without_link_writes: StatId,
    pub(super) squashed_targets: StatId,
    pub(super) squashed_target_without_link_writes: StatId,
    pub(super) squashed_target_link_writes: StatId,
    pub(super) kinds: [StatId; BranchTargetKind::COUNT],
    pub(super) link_write_kinds: [StatId; BranchTargetKind::COUNT],
    pub(super) without_link_write_kinds: [StatId; BranchTargetKind::COUNT],
    pub(super) squashed_target_kinds: [StatId; BranchTargetKind::COUNT],
    pub(super) squashed_target_link_write_kinds: [StatId; BranchTargetKind::COUNT],
    pub(super) squashed_target_without_link_write_kinds: [StatId; BranchTargetKind::COUNT],
}

#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub(super) struct RiscvO3RuntimeBranchTargetMismatchStats {
    pub(super) targetless_mismatches: StatId,
    pub(super) targetless_without_link_writes: StatId,
    pub(super) targetless_squashed_targets: StatId,
    pub(super) targetless_squashed_target_without_link_writes: StatId,
    pub(super) wrong_targets: StatId,
    pub(super) wrong_target_squashed_targets: StatId,
    pub(super) wrong_target_squashed_target_without_link_writes: StatId,
    pub(super) wrong_target_squashed_target_link_writes: StatId,
    pub(super) wrong_target_link_writes: StatId,
    pub(super) wrong_target_without_link_writes: StatId,
    pub(super) targetless_kinds: [StatId; BranchTargetKind::COUNT],
    pub(super) targetless_without_link_write_kinds: [StatId; BranchTargetKind::COUNT],
    pub(super) targetless_squashed_target_kinds: [StatId; BranchTargetKind::COUNT],
    pub(super) targetless_squashed_target_without_link_write_kinds:
        [StatId; BranchTargetKind::COUNT],
    pub(super) wrong_target_kinds: [StatId; BranchTargetKind::COUNT],
    pub(super) wrong_target_squashed_target_kinds: [StatId; BranchTargetKind::COUNT],
    pub(super) wrong_target_squashed_target_without_link_write_kinds:
        [StatId; BranchTargetKind::COUNT],
    pub(super) wrong_target_squashed_target_link_write_kinds: [StatId; BranchTargetKind::COUNT],
    pub(super) wrong_target_link_write_kinds: [StatId; BranchTargetKind::COUNT],
    pub(super) wrong_target_without_link_write_kinds: [StatId; BranchTargetKind::COUNT],
}
