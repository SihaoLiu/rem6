...
#[derive(Clone, Debug, Eq, PartialEq)]
pub struct RiscvWorkloadTraceL1InvalidationRecord {
    completion_tick: Tick,
    trace_tick: Tick,
    trace_sequence: u64,
    source_tick: Tick,
    ...
    kind: TrafficTraceSyncKind,
    kernel_sync: bool,
    invalidated_line_count: usize,
    trace_packet_id: Option<u64>,
    trace_pc: Option<Address>,
}

impl RiscvWorkloadTraceL1InvalidationRecord {
    pub(super) fn from_trace_sync_invalidation(
        completion_tick: Tick,
        sync: TrafficTraceSyncEvent,
        trace_order: TrafficTraceReplayOrder,
        invalidated_line_count: usize,
    ...
    pub const fn invalidated_line_count(&self) -> usize {
        self.invalidated_line_count
    }
