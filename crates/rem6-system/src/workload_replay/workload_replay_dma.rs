...
pub(super) struct WorkloadAcceleratorDmaActivity {
    ...
    pub(super) scheduler_empty_epoch_count: usize,
    ...
    pub(super) scheduler_planned_batch_timeline: Vec<WorkloadParallelBatchTimelineRecord>,
    pub(super) scheduler_planned_batch_worker_capacity_ticks: Tick,
