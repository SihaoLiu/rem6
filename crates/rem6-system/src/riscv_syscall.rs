...
use mmap::{
    ...
    syscall_mincore, syscall_mlock2, syscall_mlockall, syscall_mmap, syscall_mprotect,
    syscall_mremap, syscall_msync, syscall_munlockall, syscall_munmap, syscall_set_mempolicy,
    RISCV64_LINUX_MMAP_BASE, RISCV_LINUX_GET_MEMPOLICY, RISCV_LINUX_MADVISE, RISCV_LINUX_MBIND,
    RISCV_LINUX_MINCORE, RISCV_LINUX_MLOCK, RISCV_LINUX_MLOCK2, RISCV_LINUX_MMAP,
    RISCV_LINUX_MPROTECT, RISCV_LINUX_MREMAP, RISCV_LINUX_MSYNC, RISCV_LINUX_MUNLOCK,
    RISCV_LINUX_MUNMAP, RISCV_LINUX_SET_MEMPOLICY, RISCV_PAGE_BYTES,
};
#[cfg(test)]
