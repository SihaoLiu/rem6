...
pub use self::rtc::{
    ...
    RtcError, RtcInterruptError, RtcInterruptErrorKind, RtcSnapshot, RTC_CMOS_REGISTER_COUNT,
    RTC_DAY_OF_MONTH_REGISTER, RTC_DAY_OF_WEEK_REGISTER, RTC_HOURS_ALARM_REGISTER,
    RTC_HOURS_REGISTER, RTC_MINUTES_ALARM_REGISTER, RTC_MINUTES_REGISTER, RTC_MMIO_ADDRESS_OFFSET,
    RTC_MMIO_DATA_OFFSET, RTC_MMIO_REGISTER_BYTES, RTC_MONTH_REGISTER, RTC_SECONDS_ALARM_REGISTER,
    RTC_SECONDS_REGISTER, RTC_STATUS_A_REGISTER, RTC_STATUS_B_REGISTER, RTC_STATUS_C_REGISTER,
