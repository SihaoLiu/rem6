...
pub(crate) use control::MAX_PRESCALAR_SHIFT_ENTRY;
pub use control::{
    CpuLocalTimerControl, CpuLocalTimerWriteEffect, CpuLocalTimerZeroOutcome,
    CpuLocalWatchdogControl,
};
use control::{WATCHDOG_DISABLE_FIRST, WATCHDOG_DISABLE_SECOND};
