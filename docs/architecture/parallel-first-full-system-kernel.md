...
- The gem5 resources reproducibility work identifies complex disk image
  ...
  capacity, idle ticks, speedup, and utilization as typed data. Planned-load
  expectations reject suite identity drift, worker-count drift, and
