...
| `rem6-boot` | Boot images, typed ELF32 and ELF64 little-endian loadable-segment parsing, checked segment memory ranges, segments, initial memory population, and workload input metadata. |
