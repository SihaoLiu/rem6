...
- The gem5 resources reproducibility work identifies complex disk image
  ...
  timelines that do not meet sustained-occupancy, full-occupancy, or
  underoccupied-tick contracts, and reject actual execution windows that drift
  from the plan.
