...
- The gem5 resources reproducibility work identifies complex disk image
  ...
  capacity, idle worker time, speedup, and utilization. Minimum
  simultaneous-worker checks turn multi-workload orchestration into a typed
  contract instead of ad hoc external scripts:
