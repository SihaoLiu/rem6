...
- The gem5 resources reproducibility work identifies complex disk image
  ...
  deterministic manifest data, so custom monitor/control events and
  multi-workload orchestration do not need ad hoc external scripts:
