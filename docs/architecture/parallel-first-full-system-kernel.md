...
| `rem6-stats` | Typed counters, registry ownership, statistics reset and dump behavior, schema-and-reset-scope-checked snapshot deltas, and run metadata. |
...
| Statistics | Tests for registry ownership, monotonic reset behavior, schema-and-reset-scope-checked deltas, dump records, and aggregation into system summaries. |
