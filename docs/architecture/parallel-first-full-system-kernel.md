...
- The gem5 resources reproducibility work identifies complex disk image
  ...
  tick spans, occupancy utilization, and per-worker idle ticks, and reject
  actual execution windows that drift from the plan.
