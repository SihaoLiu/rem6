...
| `rem6-net` | Ethernet packet payloads, wire-length metadata, packet FIFO capacity, reservation, slack, fixed full-duplex link timing, explicit transmission records, delivery drain, and snapshot state. |
