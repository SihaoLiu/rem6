...
- The gem5 resources reproducibility work identifies complex disk image
  ...
  deterministic manifest data. Suite-level minimum simultaneous-worker checks
  turn multi-workload orchestration into a typed contract instead of ad hoc
  external scripts:
