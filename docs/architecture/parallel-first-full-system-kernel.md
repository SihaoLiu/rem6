...
- The gem5 resources reproducibility work identifies complex disk image
  ...
  assignment, expose wall-clock span, occupancy windows, and per-worker idle
  ticks, and reject actual execution windows that drift from the plan.
