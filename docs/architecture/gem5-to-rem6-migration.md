...
E64 `vfadd.vv/vf`, `vfsub.vv/vf`, `vfrsub.vf`, `vfmul.vv/vf`, `vfdiv.vv/vf`, and `vfrdiv.vf` exact finite CPU fetch-stream lanes, `vfclass.v` SEW=32 classification lanes, `vfmv.v.f`
