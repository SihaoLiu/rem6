...
fd/link visibility, vector I/O, `ppoll`, single-word `sched_getaffinity`,
zero-duration `nanosleep` validation, time, cwd, random, resource, wait, unknown
