...
ROB/LSQ-backed O3 run tests beyond retired-lifecycle, FU-latency-class, and LSQ store-forwarding traces.
...
families, and broader ROB/LSQ-backed O3 execution beyond retired-lifecycle/FU-latency/LSQ-forwarding debug and checkpoint state.
