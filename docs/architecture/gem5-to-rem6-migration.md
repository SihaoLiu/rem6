...
non-contiguous masked fault-suppression edge cases beyond current unit-stride store and strided/indexed e32/m1 translated leading-gap slices, remaining leading translated unit-stride load/segment variants, broader strided, indexed,
