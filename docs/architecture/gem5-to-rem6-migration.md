...
BTB text-alias update: executed single-core and multicore RISC-V branch-prediction text runs now map live child-BTB lookup totals, miss totals, update totals, mispredict totals, and eviction counters into `system.cpu.branchPred.btb.lookups::total`, `system.cpu.branchPred.btb.misses::total`, `system.cpu.branchPred.btb.updates::total`, `system.cpu.branchPred.btb.mispredict::total`, `system.cpu.branchPred.btb.evictions`, `system.cpu0.branchPred.btb.lookups::total`, `system.cpu0.branchPred.btb.misses::total`, `system.cpu0.branchPred.btb.updates::total`, `system.cpu0.branchPred.btb.mispredict::total`, `system.cpu0.branchPred.btb.evictions`, `system.cpu1.branchPred.btb.lookups::total`, `system.cpu1.branchPred.btb.misses::total`, `system.cpu1.branchPred.btb.updates::total`, `system.cpu1.branchPred.btb.mispredict::total`, and `system.cpu1.branchPred.btb.evictions`, including a colliding direct-jump run with positive BTB eviction evidence, without changing stats scores.
