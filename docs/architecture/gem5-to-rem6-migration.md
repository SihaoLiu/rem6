...
line as useful, preserves useful-but-miss, unused, and late-hit subcounts, records demand MSHR misses for coverage denominators, and emits prefetch
...
`system.cpu.dcache.prefetcher.pfIdentified`/`pfIssued`/`pfUseful`/`pfUsefulButMiss`/`pfUnused`/`pfHitInCache`/`pfHitInMSHR`/`pfHitInWB`/`pfLate`/`pfSpanPage`/`pfInCache`/`demandMshrMisses`
...
`system.cpu.icache.prefetcher.pfIdentified`/`pfIssued`/`pfUseful`/`pfUsefulButMiss`/`pfUnused`/`pfHitInCache`/`pfHitInMSHR`/`pfHitInWB`/`pfLate`/`pfSpanPage`/`pfInCache`/`demandMshrMisses`
...
coverage exposes tagged next-line queue enqueue/issue/useful, useful-but-miss, unused, late-hit fields, demand MSHR miss, fixed-point accuracy/coverage, and
