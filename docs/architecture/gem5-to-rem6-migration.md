...
TLS metadata, symbol-table count and dynamic needed/path/relocation metadata, extended section count/string-index
...
rejection, `.tbss` TLS plus symbol-count and dynamic needed/path/relocation JSON/stats, ELF32 extended
