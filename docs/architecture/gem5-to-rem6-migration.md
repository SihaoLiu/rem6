...
full 32-byte register-group load/store execution and misaligned rejection; and traps, translation
...
through direct and cache-backed normal data access paths, plus no-fault fault-only-first load slices covering four unmasked e8/e16/e32/e64 m1 cases and three full e32 register-group cases (m2/m4/m8) through those same paths, with vector LSU execute-stage latency before data wait on covered slices,
