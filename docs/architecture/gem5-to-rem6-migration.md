...
ROB/LSQ-backed O3 issue/commit run tests beyond aggregate runtime traces.
...
families, and broader ROB/LSQ-backed O3 execution beyond aggregate debug and checkpoint state.
