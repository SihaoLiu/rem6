...
mapped-range validation, `msync` flags and mapped-range validation, stdio, guest-backed file create/truncate/`ftruncate`/read/write/append/positioned read-write/readback and open
