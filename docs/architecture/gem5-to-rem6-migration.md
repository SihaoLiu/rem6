...
mask compare `vmfeq`, `vmfne`, and `vmflt` vv/vf SEW=32 mask results,
...
signaling-NaN invalid-flag accrual, `vmflt` signaling-compare invalid-flag accrual,
