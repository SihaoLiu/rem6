...
runs, plus e32/m1 contiguous active-tail masked load line/PMA suppression through direct and cache-backed paths, aligned e16/m2 unmasked full 32-byte and e32/m2 unmasked/masked full 32-byte, e32/m4 unmasked/masked full 64-byte, e32/m8 unmasked/masked full 128-byte register-group, three e8/m1, two e16/m1, two e32/m1, and one e64/m1 single-line plus one e64/m1 non-contiguous multi-line unmasked/masked strided vector memory slices, four e8/m1 including e16-index, e32-index, and e64-index and four e16/m1 including e8-index, e32-index, and e64-index unmasked/masked non-contiguous unordered indexed, four e32/m1 including e8-index, e16-index, e64-index, and three e32-index unmasked/masked non-contiguous variants with trailing-active lane preservation plus four e64/m1 including e8-index, e16-index, and e32-index unmasked/masked contiguous plus four e64/m1 including e8-index, e16-index, e32-index, and e64-index unmasked/masked non-contiguous unordered indexed slices moving bytes
...
non-contiguous and leading masked fault-suppression edge cases, broader strided, indexed,
