...
CLI run aggregate memory-resource activity, active-resource, and instruction/data cache-resource hierarchy stats derived from executed cache, transport, and DRAM paths,
