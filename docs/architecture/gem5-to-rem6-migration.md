...
symbol/dynamic-symbol counts, section-header/name/flag/storage/address/alignment plus `SHT_NOTE` count/byte metadata, dynamic needed/path/loader-string/table/lifecycle-scalar/array/relocation/hash/version/linker/flag and ABI-note OS metadata,
...
symbol/dynamic-symbol counts, section-header/name/flag/storage/address/alignment plus `SHT_NOTE` count/byte JSON/stats, dynamic needed/path/loader-string/table/lifecycle-scalar/array/relocation/hash/version/linker/flag JSON/stats,
