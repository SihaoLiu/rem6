...
Stats ledger note: the BTB slice now exposes `sim.cpu*.branch_predictor.btb.{lookups,hits,misses,updates,evictions,mispredictions,predicted_taken_misses}` in top-level run JSON and stats. It also maps real BTB update, hit-ratio, no-target/wrong-target, and predicted-taken BTB-miss values into gem5-style text aliases: `system.cpu.branchPred.BTBUpdates`, `system.cpu.branchPred.BTBHitRatio`, `system.cpu.branchPred.BTBMispredicted`, `system.cpu.branchPred.predTakenBTBMiss`, multicore `system.cpu0.branchPred.BTBUpdates`, `system.cpu0.branchPred.BTBHitRatio`, `system.cpu0.branchPred.BTBMispredicted`, `system.cpu0.branchPred.predTakenBTBMiss`, `system.cpu1.branchPred.BTBUpdates`, `system.cpu1.branchPred.BTBHitRatio`, `system.cpu1.branchPred.BTBMispredicted`, and `system.cpu1.branchPred.predTakenBTBMiss`. Remaining gaps are broader branch-type vector stats such as `mispredictDueToBTBMiss` by thread and branch type.
