...
fabric JSON/stat counters including flit and credit-delay counts, optional router input-VC/output-port stage latency and queue-delay timing plus executed-run router/port/VC transfer, byte, flit, latency, and queue-delay aggregate JSON/stat counters mirrored into memory-resource summaries, and
