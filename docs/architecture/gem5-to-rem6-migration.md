...
programs that match qemu for deterministic current-process priority state, priority invalid-target returns, and scheduler state/error boundaries; and a no-libc static raw capability program that
