...
finite-quotient static directed rounding with NX accrual, `fcvt.s.d` static/dynamic directed rounding with NX accrual, `fcvt.d.s` signaling-NaN invalid accrual, `fmadd.s` exact-window
...
symbol type, binding, visibility, section-index, TLS-type, and IFUNC-type counts plus dynamic-symbol type, binding, and visibility counts, section-header/name/flag/storage/string-table/array/hash/group/address/alignment plus `SHT_NOTE` and `SHT_REL`/`SHT_RELA`/`SHT_RELR` count/byte metadata, dynamic needed/path/loader-string/table/lifecycle-scalar/array/REL/RELA/RELR relocation/hash/version/linker/flag and ABI-note OS metadata,
...
symbol type, binding, visibility, section-index, TLS-type, and IFUNC-type counts plus dynamic-symbol type, binding, and visibility counts, section-header/name/flag/storage/string-table/array/hash/group/address/alignment plus `SHT_NOTE` and `SHT_REL`/`SHT_RELA`/`SHT_RELR` count/byte JSON/stats, dynamic needed/path/loader-string/table/lifecycle-scalar/array/REL/RELA/RELR relocation/hash/version/linker/flag JSON/stats,
