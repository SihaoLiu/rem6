...
and `vse8`/`vse16`/`vse32`/`vse64` m1 CPU data-path execution, masked e32/m1
unit-stride `vle32`/`vse32` CPU data-path execution, plus aligned `e32,m2`
...
configurations, masked e32/m1 inactive-lane preservation through direct top-level
...
masked width/LMUL breadth and fault-suppression edge cases, strided, indexed,
