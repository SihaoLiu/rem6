...
symbol/dynamic-symbol counts, dynamic needed/path/table/lifecycle/relocation/hash/flag and ABI-note OS metadata,
...
symbol/dynamic-symbol counts, dynamic needed/path/table/lifecycle/relocation/hash/flag JSON/stats,
