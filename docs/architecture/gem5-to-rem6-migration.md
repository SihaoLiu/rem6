...
credit depth, and aggregate, per-virtual-network, per-link, and per-link/per-VN lane
...
occupancy, queue-delay, credit-delay, contention, per-virtual-network, per-link, per-link/per-VN lane, and per-hop activity stats from
...
network and credit-depth config fields plus per-virtual-network, per-link, and per-link/per-VN lane
...
selection, credit-depth validation, aggregate/per-VN/per-link/per-hop fabric stats, and link/lane/hop activity,
