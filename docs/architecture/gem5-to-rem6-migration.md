...
**Next evidence:** Remaining per-cycle in-order squashes and stalls beyond current resource/ordering blocked-cycle, fetch/data/execute wait, and widened trap-redirect flush stats/debug attribution, remaining
