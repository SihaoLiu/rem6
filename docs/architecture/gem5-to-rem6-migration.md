...
selection, credit-depth validation, aggregate/per-VN/per-link/per-hop fabric stats, and lane/hop activity,
...
DRAM read, explicit fabric route lane/hop activity and per-link/per-hop fabric stats, and
