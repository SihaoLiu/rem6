...
`sched_getaffinity`, zero-duration `nanosleep` validation, time, cwd, random, resource, wait, unknown
...
`riscv_se_stdio`, `riscv_syscall::tests::scheduler_tests`,
