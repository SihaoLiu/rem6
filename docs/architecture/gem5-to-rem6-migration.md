...
- [ ] GDB hardware breakpoint, RV32 FP/vector register cache, and broader CSR register cache exist.
...
hardware breakpoint handling, RV32 FP/vector and broader CSR GDB register cache,
...
single-step, continue, `vCont;c`, and data-watchpoint smoke tests,
...
cache/bank/fabric runtime resource counters, GDB hardware breakpoint
