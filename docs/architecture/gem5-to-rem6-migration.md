...
non-contiguous masked fault-suppression edge cases beyond current unit-stride load/store and strided/indexed e32/m1 translated leading-gap slices, remaining leading translated segment variants, broader strided, indexed,
