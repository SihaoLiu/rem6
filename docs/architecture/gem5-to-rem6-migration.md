...
branch/trap/interrupt redirect counters and flush-cycle stats from real redirect cycle records,
...
**Next evidence:** Remaining per-cycle in-order squashes and stalls beyond current movement, resource/ordering blocked-cycle, fetch/data/execute wait, widened trap/debug edges, and interrupt flush-with-youngers attribution, remaining
