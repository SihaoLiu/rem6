...
ROB/LSQ-backed O3 run tests beyond retired-lifecycle, FU-latency-class, LSQ store-forwarding, vector LSQ byte accounting, and scheduled checkpoint restore/replay traces.
