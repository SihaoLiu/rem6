...
CLI run aggregate memory-resource activity, active-resource, instruction/data cache-resource hierarchy, and prefetch queue/translation-queue stats derived from executed cache, transport, and DRAM paths,
