...
`system.cpu.numInsts`/`system.cpu.numOps`/`system.cpu.numCycles` aliases plus derived `system.cpu.ipc`/`system.cpu.cpi`, and multicore
`system.cpuN.numInsts`/`system.cpuN.numOps`/`system.cpuN.numCycles` aliases plus derived `system.cpuN.ipc`/`system.cpuN.cpi`,
...
`numInsts`/`numOps`/`numCycles` aliases plus `ipc`/`cpi` rates, and multicore CPU `numInsts`/`numOps`/`numCycles` aliases plus `ipc`/`cpi` rates
