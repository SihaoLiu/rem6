...
`vdivu`/`vdiv`/`vremu`/`vrem`, integer reductions `vredsum`/`vredand`/`vredor`/`vredxor`/`vredminu`/`vredmin`/`vredmaxu`/`vredmax` plus `vwredsumu`/`vwredsum`, and mask compare
