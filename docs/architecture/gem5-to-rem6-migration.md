...
**Next evidence:** Remaining per-cycle in-order squashes and stalls beyond current resource/ordering blocked-cycle, fetch/data/execute wait, branch-redirect flush-cycle/flush-cause attribution, and widened trap-redirect flush stats/debug attribution, remaining
