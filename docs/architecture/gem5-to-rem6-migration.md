...
direct-jump history when steering younger conditional branches without mutating
committed predictor history,
...
squashes, executable O3 timing, remaining Tournament/TAGE-SC-L/multiperspective
...
completed-fetch overlap, selected GShare and BiMode speculative-history overlays
for younger fetch-ahead branch prediction, scalar integer multiply execute-stage latency through
...
Tournament/TAGE-SC-L/multiperspective predictor-family speculation snapshots and rollback, full checker integration for future timing
