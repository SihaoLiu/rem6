...
fd/link visibility, vector I/O, guest-file `sendfile`, `ppoll`,
`eventfd2` counter, semaphore, nonblock, close-on-exec, poll-readiness, and
actual ecall read-to-exit smoke slices, `sched_getscheduler`, `sched_getparam`,
