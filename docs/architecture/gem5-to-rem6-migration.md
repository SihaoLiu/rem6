...
through direct and cache-backed normal data access paths, plus no-fault fault-only-first load slices covering four unmasked e8/e16/e32/e64 m1 cases and two full e32 register-group cases (m2 and m4) through those same paths, with vector LSU execute-stage latency before data wait on covered slices,
...
load/store forms beyond current unit-stride m1, no-fault fault-only-first loads covering four unmasked e8/e16/e32/e64 m1 cases and two full e32 register-group cases (m2 and m4), three e8/m1, two e16/m1, two e32/m1, and one e64/m1 single-line plus one e64/m1 non-contiguous multi-line unmasked/masked strided slices, four e8/m1 including e16-index, e32-index, and e64-index and four e16/m1 including e8-index, e32-index, and e64-index unmasked/masked non-contiguous unordered indexed, four e32/m1 including e8-index, e16-index, and e64-index unmasked/masked contiguous plus six e32/m1 including e8-index, e16-index, e64-index, and three e32-index unmasked/masked non-contiguous variants and four e64/m1 including e8-index, e16-index, and e32-index unmasked/masked contiguous plus four e64/m1 including e8-index, e16-index, and e64-index unmasked/masked non-contiguous unordered indexed slices, plus aligned e32/m2, e32/m4, and e32/m8 full-register-group slices, broader TAGE-SC-L and multiperspective-perceptron mutable predictor-family speculation snapshots
