...
plus RV64D `fsqrt.d` directed rounding/NX ELF smoke and RV64F/RV64D scalar FP slices including `fcvt.s.d` directed rounding/NX and `fcvt.d.s` signaling-NaN invalid accrual.
...
ELF32 extended counts, ABI-note OS, DTB, RV64D `fsqrt.d` ELF smoke, and RV64F/RV64D `fcvt.s.d`/`fcvt.d.s` tests.
