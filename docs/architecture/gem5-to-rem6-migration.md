...
valid/invalid flag validation with direct ecall coverage, stdio, guest-backed file create/truncate/`ftruncate`/read/write/append/positioned read-write/readback and open
