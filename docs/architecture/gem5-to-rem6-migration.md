...
Detailed O3 commit text aliases include `system.cpu.commit.committedInstType_0::MemRead`, `system.cpu.commit.committedInstType_0::MemWrite`, `system.cpu.commit.committedInstType_0::IntMult`, `system.cpu.commit.committedInstType_0::IntDiv`, `system.cpu.commit.committedInstType_0::FloatMisc`, and `system.cpu.commit.committedInstType_0::SimdFloatMisc` from the same detailed-mode runtime counters.
...
summary.
Detailed O3 commit text-stat coverage includes `system.cpu.commit.committedInstType_0::MemRead`, `system.cpu.commit.committedInstType_0::MemWrite`, `system.cpu.commit.committedInstType_0::IntMult`, `system.cpu.commit.committedInstType_0::IntDiv`, `system.cpu.commit.committedInstType_0::FloatMisc`, and `system.cpu.commit.committedInstType_0::SimdFloatMisc` aliases derived from path-safe raw committed-inst-type counters.
