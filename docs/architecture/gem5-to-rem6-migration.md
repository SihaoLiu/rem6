...
broader CSR GDB register-cache coverage, integrated debug-run stat roll-up,
...
cache/bank/fabric runtime resource counters, broader CSR register-cache tests,
and O3 checkpoint capture/restore.
