...
extension probes, functional firmware-emulated DBCN shared-memory write and
direct write-byte debug-console output without topology-routed firmware memory
transactions or full DBCN advertisement, minimal TIME `set_timer` STIP
scheduling, IPI
