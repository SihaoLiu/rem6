...
symbol/dynamic-symbol counts, dynamic needed/path/table/lifecycle-scalar/array/relocation/hash/flag and ABI-note OS metadata,
...
symbol/dynamic-symbol counts, dynamic needed/path/table/lifecycle-scalar/array/relocation/hash/flag JSON/stats,
