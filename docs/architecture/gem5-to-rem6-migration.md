...
vector load-store functional-unit latency tables, broader predictor-family speculation snapshots
...
The target-provider slice exposes `sim.cpu*.branch_predictor.target_provider.{no_target,btb,ras,indirect,total}` counters and maps current real BTB-selected and no-target providers to `system.cpu.branchPred.targetProvider_0::BTB`, `system.cpu.branchPred.targetProvider_0::NoTarget`, `system.cpu.branchPred.targetProvider_0::total`, multicore `system.cpu0.branchPred.targetProvider_0::BTB`, `system.cpu0.branchPred.targetProvider_0::NoTarget`, `system.cpu0.branchPred.targetProvider_0::total`, `system.cpu1.branchPred.targetProvider_0::BTB`, `system.cpu1.branchPred.targetProvider_0::NoTarget`, and `system.cpu1.branchPred.targetProvider_0::total`; RAS and indirect provider lanes remain zero until those target providers are wired into the executable fetch path.
