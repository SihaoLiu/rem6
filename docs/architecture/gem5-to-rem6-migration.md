...
non-retentive `hart_suspend` slices, RFENCE hypervisor-fence and completion
semantics, full Linux boot, and real benchmark workloads.
...
completion tests, then a real Linux boot smoke.
