...
**Not migrated:** Ruby-scale protocol networks, gem5-class router and virtual-channel NoC detail, named full JEDEC timing-table breadth beyond custom timing rows, broader instruction-cache and non-MSI hierarchy-level prefetch translation consumers, and additional DRAM refresh modes beyond per-bank/all-bank policy.
