...
`system.cpu.numInsts`/`system.cpu.numOps`/`system.cpu.numCycles` aliases, and multicore
`system.cpuN.numInsts`/`system.cpuN.numOps`/`system.cpuN.numCycles` aliases,
...
`numInsts`/`numOps`/`numCycles` aliases, and multicore CPU `numInsts`/`numOps`/`numCycles`
