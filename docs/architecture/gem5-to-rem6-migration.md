...
from the resulting workload parallel summary.
...
transfer, and byte stats from the top-level replay command.
...
fabric-route activity counters, O3 writeback transfer
...
the same workload parallel summary.
