...
symbol/dynamic-symbol counts, dynamic needed/path/relocation/hash/flag and ABI-note OS metadata,
...
symbol/dynamic-symbol counts, dynamic needed/path/relocation/hash/flag JSON/stats,
