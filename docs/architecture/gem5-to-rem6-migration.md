...
symbol/dynamic-symbol counts, section-header and section-name table metadata, dynamic needed/path/loader-string/table/lifecycle-scalar/array/relocation/hash/version/linker/flag and ABI-note OS metadata,
...
symbol/dynamic-symbol counts, section-header and section-name table JSON/stats, dynamic needed/path/loader-string/table/lifecycle-scalar/array/relocation/hash/version/linker/flag JSON/stats,
