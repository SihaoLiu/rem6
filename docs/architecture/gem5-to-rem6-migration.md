...
set/get, no-new-privs, and parent-death-signal state slices, `personality` query/set state, single CPU/node
...
`prctl` no-new-privs and parent-death-signal programs that match qemu; a static raw
