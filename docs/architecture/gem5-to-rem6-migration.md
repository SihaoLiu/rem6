...
- [x] Top-level RISC-V instruction/data traffic can use explicit L1/L2/L3 cache hierarchy and fabric-routed DRAM.
...
cache/fabric/DRAM smoke exposing `sim.memory.fabric.*` counters. DRAM
