...
**Next evidence:** Broader per-cycle in-order squashes and remaining stalls beyond current resource/ordering blocked-cycle, fetch/data/execute wait, and branch-redirect flush-cycle/flush-cause attribution, remaining
