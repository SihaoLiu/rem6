...
`sched_setparam`, `sched_setscheduler`, `sched_getscheduler`, `sched_getparam`, `sched_getattr`,
...
argument errors; static raw `getpriority`/`setpriority`, `ioprio_get`/`ioprio_set`, and `sched_getattr`
