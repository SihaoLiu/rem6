...
TLS metadata, symbol-table count and dynamic-table metadata, extended section count/string-index
...
rejection, `.tbss` TLS plus symbol-count and dynamic-table JSON/stats, ELF32 extended
