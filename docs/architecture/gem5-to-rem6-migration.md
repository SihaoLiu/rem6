...
**Not migrated:** Ruby-scale protocol networks, gem5-class router and virtual-channel NoC detail, full JEDEC timing-table breadth, broader instruction-cache and non-MSI hierarchy-level prefetch translation consumers, and additional DRAM refresh modes.
...
**Next evidence:** Ruby-scale protocol-network execution, router and virtual-channel NoC arbitration beyond top-level shared-link/per-VN lane pressure, additional DRAM refresh modes and full JEDEC timing-table coverage, broader low-power state matrices, and instruction-cache/non-MSI hierarchy-level prefetch translation consumers.
