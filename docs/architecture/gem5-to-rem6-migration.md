...
**Score calculation:** 16 of 20 items have executable evidence, or 80% raw,
...
- [ ] GDB hardware breakpoint, read/access watchpoint, RV32 FP/vector register cache, and broader CSR register cache exist.
...
runtime GDB write-watchpoint execution through a real RISC-V store data-access
completion with detach-time continuation of later guest instructions,
...
hardware breakpoint handling, read/access watchpoint handling, RV32 FP/vector
and broader CSR GDB register cache, integrated debug-run stat roll-up, runtime
resource counters, runtime-calibrated power/thermal, and broad O3 ROB/LSQ/rename
...
single-step, continue, `vCont;c`, and write-watchpoint smoke tests,
...
cache/bank/fabric runtime resource counters, GDB hardware breakpoint plus
read/access watchpoint execution-control integration, RV32 FP/vector and
