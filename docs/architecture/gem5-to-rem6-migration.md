...
BTB text-alias update: executed single-core and multicore RISC-V branch-prediction text runs now map live child-BTB miss totals and eviction counters into `system.cpu.branchPred.btb.misses::total`, `system.cpu.branchPred.btb.evictions`, `system.cpu0.branchPred.btb.misses::total`, `system.cpu0.branchPred.btb.evictions`, `system.cpu1.branchPred.btb.misses::total`, and `system.cpu1.branchPred.btb.evictions`, including a colliding direct-jump run with positive BTB eviction evidence, without changing stats scores.
