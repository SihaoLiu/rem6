...
ROB/LSQ-backed O3 run tests beyond event-level retired lifecycle traces.
...
families, and broader ROB/LSQ-backed O3 execution beyond event-level debug and checkpoint state.
