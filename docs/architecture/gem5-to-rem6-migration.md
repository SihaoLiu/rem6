...
direct write-byte debug-console output, and DBCN advertisement when functional
guest memory I/O is configured, without topology-routed firmware memory
