...
- Configuration and experiment reproducibility are too script-dependent in
  ...
  suite result-derived execution evidence, per-workload result start/final windows, worker-level
