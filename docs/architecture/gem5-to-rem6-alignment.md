...
- Full-system RISC-V tests drive multicore fetch, data access, traps, host stop,
  ...
  the declared directory placement, and workload replay tests cover RISC-V
  fetches and data loads from non-first memory targets with different line
  layouts. Workload
