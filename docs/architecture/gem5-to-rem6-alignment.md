...
- RISC-V PMA anchor refreshed on 2026-05-30: gem5's local `PMAChecker` keeps
  ...
  lines reject the bypass until eviction/writeback support exists, and
  write-buffer-shaped uncacheable writes plus NoC scheduling consumption of
  those flags remain alignment targets.
...
- Cache MSHR, MSI/MESI/MOESI/CHI cache-bank, and MSI bank directory harness
  ...
  bypass while preserving dirty snapshot evidence.
