...
- RTC core tests cover MC146818-compatible binary and BCD calendar registers,
  ...
  both serial and parallel MMIO scheduler paths. SP805 tests cover watchdog
  countdown, zero-load minimum-clock
