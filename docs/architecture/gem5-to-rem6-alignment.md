...
- Fabric QoS tests cover explicit fixed-priority requestor mapping,
  ...
  access and byte accounting in DRAM activity profiles. Coherence, system, and
  DMA run-summary tests cover direct DRAM QoS diagnostics over those typed
  activity profiles.
