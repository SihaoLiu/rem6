...
- Observability and statistics need stronger contracts. Public gem5 issue
  ...
  target-PC filters, one-shot target-pair hit updates, and cursor-free snapshot
  restore validation instead of CPU pointer plus manager pointer coupling.
