...
- Error surfaces are split across simulator fatal errors, simulator panics, and
  ...
  active-thread list queries, single-block thread-list replies, thread-list
  end replies, `qSupported` feature tokens, `qSupported` response feature emission,
...
- Debug packet tests cover GDB remote packet checksum encoding and decoding,
  ...
  active-thread list parsing, thread-list response emission, `qSupported`
  feature parsing, stub feature response emission,
