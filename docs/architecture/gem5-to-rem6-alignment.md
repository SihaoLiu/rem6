...
- Make the RISC-V execution path capable of mainstream software: RV64GC still
  ...
  at frontend line and page boundaries, plus floating-point decode/execute
  coverage, the current host-assisted mode has guest fd and futex state but not
  a syscall handler table, and Linux handoff still needs an SBI-class
