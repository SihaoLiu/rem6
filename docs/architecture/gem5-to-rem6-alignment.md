...
- Configuration and experiment reproducibility are too script-dependent in
  ...
  identities, suite dispatch records, suite result-derived execution
  evidence, per-workload result start/final windows, worker-level suite
  completion summaries, round-robin or weighted suite dispatch plans,
