...
- Complete CHI-like coherence coverage and richer cache internals such as
  additional prefetchers, QoS, sector/compressed tags, and cache write queues.
