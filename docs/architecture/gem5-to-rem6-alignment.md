...
- Stats tests cover registry-owned stat groups, self-describing group catalogs
  ...
  cursor-preserving snapshot restore records with malformed snapshot rejection.
