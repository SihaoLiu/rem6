...
- MSI, MESI, MOESI, and initial CHI-like line-state, cache-controller,
  ...
  and topology-built CHI cache-directory routes have test coverage; full
...
- Complete CHI-like coherence beyond the current line-state crate, single-line
  ...
  plus initial partitioned and topology-built cache-directory harnesses, plus
