...
- RISC-V PMA anchor refreshed on 2026-05-30: gem5's local `PMAChecker` keeps
  ...
  and avoiding MSHR or line installation. NoC scheduling consumption of those
  flags and write-response plumbing for queued uncacheable writes remain
  alignment targets.
