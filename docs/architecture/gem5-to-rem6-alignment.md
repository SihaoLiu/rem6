...
- gem5 cache tags split set selection between SetAssociative and
  ...
  MSI, MESI, and MOESI cache banks can now opt into those compressed tags for
  explicit compressed-size fills, hit-path replacement access, resident
  ...
  CHI compressed-tag bank integration remains a separate alignment target.
...
- Cache indexing and replacement-directory tests cover gem5-style
  ...
  MSI, MESI, and MOESI cache-bank compressed-tag tests cover explicit
...
- Complete CHI-like coherence beyond the current line-state crate, single-line
  ...
  and CHI compressed-tag bank integration.
