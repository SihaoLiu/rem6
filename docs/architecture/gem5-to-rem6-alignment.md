...
- PCI tests cover typed legacy INTx line mapping, invalid interrupt-pin and
  ...
  PMCSR snapshot restore, PCIe device and link control/status snapshot restore,
  PCIe read-only device capability rejection, and overlap rejection without
