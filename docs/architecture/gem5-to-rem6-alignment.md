...
- MSI, MESI, MOESI, and initial CHI-like line-state behavior have protocol
  harness coverage; full system paths already report data-cache protocol
  attribution.
...
- Complete CHI-like coherence beyond the current line-state crate and richer
  cache internals such as additional prefetcher algorithms, prefetch
