...
- Parallel simulation is not a natural baseline in gem5. Historical Parallel M5
  ...
  sustained tick-streak, and thresholded worker-tick contracts use the same
  dedicated manifest scopes.
