...
- Full-system RISC-V tests drive multicore fetch, data access, traps, host stop,
  ...
  a ready frontend request through direct or parallel-transport-delivered PTE
  responses to frontend completion.
