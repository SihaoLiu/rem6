...
byte accounting, `LockedRMWReadReq` command-id 30 maps to a native locked-RMW
read request with writable intent, response data, and read byte accounting,
