...
- Cache prefetch tests cover tagged next-line candidate generation, DCPT masked
  ...
  reserve handling, functional-read satisfaction, snapshot restore, and MSI
  bank write queue attachment, ready issue, conflict lookup, uncacheable-match
...
- Complete CHI-like coherence beyond the current line-state crate, single-line
  ...
  sector/compressed tags, MESI/MOESI/CHI bank write queue issue paths, and
  replacement-triggered writeback enqueue.
