...
- Cache MSHR, MSI/MESI/MOESI/CHI cache-bank, and MSI bank directory harness
  ...
  MSHR queues, cache banks, and snapshots, parallel-cycle history counts by
  effective requestor and priority, and byte-snapshot restore of MSHR queue
  configuration plus target QoS state.
