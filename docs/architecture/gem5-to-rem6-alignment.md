...
dense-id matrix assumptions and silent duplicate-edge overwrite. Gzip trace
streams, non-memory command coverage, flag-to-request mapping, text config
parsing, binding graph states to concrete generators, and transport retry or
