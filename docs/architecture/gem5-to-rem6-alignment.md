...
- Cache MSHR and MSI/MESI/MOESI/CHI cache-bank tests cover typed QoS class
  metadata, QoS-aware ready ordering, promotion of merged same-line targets to
  the highest effective priority, and snapshot restore of effective QoS state.
