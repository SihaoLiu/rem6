...
- Parallel simulation is not a natural baseline in gem5. Historical Parallel M5
  ...
  `MemoryTrace`, giving NoC and external-memory latency checks an explicit
  stats surface. Planned batches now also expose stable host worker-lane
