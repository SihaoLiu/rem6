...
- Full-system RISC-V tests drive multicore fetch, data access, traps, host stop,
  ...
  layouts. RISC-V ISA and frontend tests cover `LR.D` decode, execution,
  read-shared issue, register completion, and typed load-reservation recording.
