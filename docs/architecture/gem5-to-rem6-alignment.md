...
- MSI, MESI, MOESI, and initial CHI-like line-state, cache-controller,
  cache-bank, directory, and serial plus partitioned coherence-harness behavior
  have test coverage; full system paths already report data-cache protocol
  attribution.
...
- Complete CHI-like coherence beyond the current line-state crate, single-line
  ...
  plus initial partitioned harnesses, plus richer cache internals such as
