...
- Error surfaces are split across simulator fatal errors, simulator panics, and
  ...
  scheduler handoff, `p n` single-register read requests, target-order register-byte
