...
- Cache prefetch tests cover tagged next-line candidate generation, DCPT masked
  ...
  secure-bit separation, snapshot restore, AMPM cross-hot-zone access-map
  matching, AMPM useful-prefetch
