...
- Workload manifests record boot images, resources, topology, host events,
  ...
  with initrd resource validation, result metadata, execution mode switches,
  host action summaries, checkpoint restore labels, and statistics snapshots.
