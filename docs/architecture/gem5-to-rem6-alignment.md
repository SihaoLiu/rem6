...
- Observability and statistics need stronger contracts. A gem5 issue about
  ...
  the final snapshot and the ordered stats-control record stream. Counter paths
  are structured
