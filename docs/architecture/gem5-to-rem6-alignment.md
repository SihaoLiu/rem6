...
- Parallel simulation is not a natural baseline in gem5. Historical Parallel M5
  ...
  host worker lane without relying on worker-slot totals alone. CLI RISC-V
  data-access stats also carry total and per-core
