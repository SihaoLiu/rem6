...
- Observability and statistics need stronger contracts. Public gem5 issue
  ...
  payloads, and snapshot validation. Memory trace probes now keep gem5's packet
