...
- RTC core tests cover MC146818-compatible binary and BCD calendar registers,
  ...
  control writes, raw and masked interrupt latching, interrupt clearing,
  ...
  timer windows, serial and parallel response paths, serial and parallel
  interrupt pulses, and typed width or unknown-register errors.
