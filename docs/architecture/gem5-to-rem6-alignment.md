...
- Fabric QoS tests cover explicit fixed-priority requestor mapping,
  ...
  full-system remote contracts that include GPU and accelerator DMA scheduler
  remote-send and remote-flow evidence,
