...
- Parallel simulation is not a natural baseline in gem5. Historical Parallel M5
  ...
  tick activity, sustained minimum-worker tick streak activity, and sustained
  same-batch streak activity as core kernel contracts.
...
- Error surfaces are split across simulator fatal errors, simulator panics, and
  ...
  activity contracts and sustained minimum-worker tick streak contracts derived
  from exact batch timeline evidence,
