...
- `rem6-net` now has a typed SINIC PCI endpoint spec aligned with gem5
  ...
  into BAR-local SINIC registers. The remaining SINIC checksum offload and
  richer network interrupt delivery remain open.
