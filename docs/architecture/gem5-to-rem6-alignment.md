...
- Full-system RISC-V tests drive multicore fetch, data access, traps, host stop,
  ...
  different line layouts, and direct topology DRAM tests cover redirected
  fetches and data loads into addressed targets with different line layouts.
  Workload
