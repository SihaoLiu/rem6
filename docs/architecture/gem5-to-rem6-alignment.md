...
- Cache MSHR, MSI/MESI/MOESI/CHI cache-bank, and MSI bank directory harness
  ...
  coalesced-target effective QoS, and snapshot restore of effective QoS state.
