...
- `rem6-virtio` now keeps queue indexes, queue specs, notify specs, queue
  ...
  helpers. VirtIO console now exposes gem5's device id 3, size feature, and
  ...
  completions and actual receive byte counts. VirtIO MMIO transport now
...
- VirtIO tests cover legacy RNG device id and zero-config behavior,
  ...
  readable/empty RNG descriptor rejection, console device id, size feature,
  ...
  used-ring writeback, and console descriptor direction rejection, legacy MMIO
