...
- Compatibility bugs cluster around cross-subsystem seams. Recent public gem5
  ...
  snapshot/restore preserves streaks and diagnostics. This makes LR/SC
  starvation evidence available to full-system progress checks instead of
  hiding it in warnings and protocol-local latency side effects.
