...
- Cache prefetch tests cover tagged next-line candidate generation, DCPT masked
  ...
  MSI/MESI/MOESI/CHI bank write queue attachment, ready issue, conflict lookup, uncacheable-match
