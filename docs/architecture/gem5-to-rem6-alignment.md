...
- Simple models are not automatically cheap or transparent. Recent call-stack
  ...
  direction. rem6-fabric also keeps gem5's proportional-fair QoS score formula
  as a typed requestor policy, maps the gem5 rank into rem6's
  low-number-served-first priority convention, validates finite weights in
