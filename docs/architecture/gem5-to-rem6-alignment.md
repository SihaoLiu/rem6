...
checkpoint and abort-restore contract that trace HTM abort sidebands can bind to
once workload replay owns a live core target. `PrintReq` packet-trace commands now
