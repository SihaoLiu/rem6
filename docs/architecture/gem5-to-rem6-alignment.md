...
- Simple models are not automatically cheap or transparent. Recent call-stack
  ...
  divider construction, overflow checks, and frequency queries. This covers the
  local period-selection and derived-divider part of gem5 `SrcClockDomain` and
  `DerivedClockDomain`; live source-to-derived propagation, clocked-object
