...
- Power tests cover typed power state domains, leader/follower matching,
  ...
  reset-scope-checked stat-delta binding, duplicate binding rejection, missing
  bound-stat rejection, input updates, and snapshot restore. Thermal tests cover RC domain temperature updates from typed
