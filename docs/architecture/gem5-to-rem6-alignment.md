...
- The gem5 output path convention writes run artifacts such as configuration
  ...
  side effect. Device boot, richer runtime controls, and full-system run
  plumbing remain separate acceptance targets.
