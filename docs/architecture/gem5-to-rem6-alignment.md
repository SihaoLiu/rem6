...
- Error surfaces are split across simulator fatal errors, simulator panics, and
  ...
  transition volume, declared-threshold livelock diagnostic records, subject queries, kind summaries, kind-filtered subject and record queries, tick windows, and dirty-subject failure evidence, fabric/DRAM
