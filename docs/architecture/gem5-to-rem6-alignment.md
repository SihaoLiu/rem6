...
- Error surfaces are split across simulator fatal errors, simulator panics, and
  ...
  manifest-verifiable minimum remote-delay floors and maximum remote-delay ceilings,
...
- Fabric QoS tests cover explicit fixed-priority requestor mapping,
  ...
  empty-epoch, dispatch counts, exact progress-free transition records and counts,
