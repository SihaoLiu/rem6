...
- VirtIO tests cover modern PCI common-config feature-page selection,
  ...
  direction rejection, and get-id output shape validation. VirtIO PCI ISR-status
