...
- Simple models are not automatically cheap or transparent. Recent call-stack
  ...
  byte, occupancy, and queue-delay contracts so NoC hotspots remain typed replay
  evidence.
