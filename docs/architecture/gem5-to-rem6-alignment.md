...
an executable run artifact instead of only as a raw delivery list. A typed traffic
...
workload/CLI GUPS binding, fabric-backed GUPS transport, and broader transport
