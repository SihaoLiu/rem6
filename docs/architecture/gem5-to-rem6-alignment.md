...
- Simple models are not automatically cheap or transparent. Recent call-stack
  ...
  byte, occupancy, queue-delay, peak queue-delay, and activity-window coverage
  contracts so NoC hotspots remain typed replay evidence.
