...
- CPU branch prediction exposes typed direction prediction, GShare PC-history
  ...
  integration, branch-target lookup, TAGE folded-history indexing and provider
  selection, indirect-target lookup, deterministic replacement, update, target,
