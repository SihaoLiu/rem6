...
- RISC-V PMA anchor refreshed on 2026-05-30: gem5's local `PMAChecker` keeps
  ...
  no-merge rule without hiding it behind packet flags. Full uncacheable cache
  bypass and NoC scheduling consumption of those flags remain alignment
  targets.
