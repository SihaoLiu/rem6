...
- Configuration and experiment reproducibility are too script-dependent in
  ...
  suite-level execution efficiency summaries, and explicit boot handoff reports
  as the authority for platform and workload state.
