...
- VirtIO tests cover modern PCI common-config feature-page selection,
  ...
  copy-on-write overlays, deterministic dirty-sector snapshots, and explicit
  writeback to the child image.
