...
- Configuration and experiment reproducibility are too script-dependent in
  ...
  evidence, timed suite execution windows, worker-level suite completion
  summaries, and explicit boot handoff reports as the authority for platform
  and workload state.
