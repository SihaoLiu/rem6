...
- Parallel simulation is not a natural baseline in gem5. Historical Parallel M5
  ...
  low-power counters, NVM persistent-write and pending-queue counters,
  technology one-hot stats, and profiled external-memory capacity
  denominators. CLI
