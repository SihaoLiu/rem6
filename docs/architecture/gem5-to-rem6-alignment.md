...
- Configuration and experiment reproducibility are too script-dependent in
  ...
  evidence, worker-level suite completion summaries, and explicit boot handoff
