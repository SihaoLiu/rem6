...
- Cache MSHR, MSI/MESI/MOESI/CHI cache-bank, and MSI bank directory harness
  ...
  coalesced-target and parallel-cycle effective QoS, and byte-snapshot restore
  of MSHR queue configuration plus target QoS state.
