...
- Parallel simulation is not a natural baseline in gem5. Historical Parallel M5
  ...
  and merged full-system partition checks include the DMA timeline-derived
  sets and streaks.
