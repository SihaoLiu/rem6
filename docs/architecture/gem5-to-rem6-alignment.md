...
- MSI, MESI, MOESI, and initial CHI-like line-state, cache-controller,
  ...
  and topology-built CHI cache-directory and DRAM routes have test coverage; full
