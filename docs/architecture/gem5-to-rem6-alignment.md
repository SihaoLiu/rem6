...
- Power tests cover typed power state domains, leader/follower matching,
  ...
  multi-domain implicit temperature solving, typed power inputs, expression
  input temperature coupling, invalid topology rejection, update history, and
  snapshot restore.
