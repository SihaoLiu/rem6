...
- PCI tests cover typed legacy INTx line mapping, invalid interrupt-pin and
  ...
  endpoint identity preservation after root-line mapping, serial and parallel
  endpoint post/clear delivery through rem6-interrupt, and observable delivery
  errors when a parallel clear targets a mismatched source. PCI config and host
  tests cover 64-bit memory BAR lower
