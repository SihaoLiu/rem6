...
- `rem6-storage` now owns gem5 `DiskImage`, `RawDiskImage`, and `CowDiskImage`
  ...
  any image, and reject malformed payloads without partial mutation. Storage
