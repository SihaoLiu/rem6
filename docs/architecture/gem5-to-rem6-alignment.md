...
- Error surfaces are split across simulator fatal errors, simulator panics, and
  ...
  action packets, ordered typed resume-action records, `p n` single-register read requests, target-order register-byte
