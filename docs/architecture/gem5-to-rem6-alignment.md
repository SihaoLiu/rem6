...
- Configuration and experiment reproducibility are too script-dependent in
  ...
  timeline-derived execution summaries, suite result-derived execution
  evidence, per-workload result start/final windows, worker-level
