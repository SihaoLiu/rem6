...
- Cache prefetch tests cover tagged next-line candidate generation, DCPT masked
  delta-pair matching with earliest historical replay and snapshot restore, AMPM
  cross-hot-zone access-map matching, AMPM useful-prefetch accounting,
  AMPM epoch degree increase and decrease with snapshot restore,
