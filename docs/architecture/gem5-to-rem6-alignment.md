...
- Fabric QoS tests cover explicit fixed-priority requestor mapping,
  ...
  direct QoS batch eligibility. DRAM tests cover QoS-driven same-arrival request ordering
