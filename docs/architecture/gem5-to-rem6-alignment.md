...
- VirtIO tests cover modern PCI common-config feature-page selection,
  ...
  cap64 offset and length splitting, unique region ids, declared BAR
  containment, missing or duplicate BAR rejection, zero-length rejection,
  same-BAR overlap rejection, and BAR-filtered region queries.
