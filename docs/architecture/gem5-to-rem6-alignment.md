...
- VirtIO tests cover modern PCI common-config feature-page selection,
  ...
  guest-visible capability chains, and pre-mutation rejection for undeclared
  BAR references, out-of-BAR regions, and same-BAR overlaps. VirtIO PCI ISR-status
