...
- Full-system RISC-V tests drive multicore fetch, data access, traps, host stop,
  ...
  the system parallel run driver with an explicit page map and assert that
  multicore responders observe physical data addresses; workload
