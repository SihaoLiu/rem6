...
- MSI, MESI, MOESI, and initial CHI-like line-state and cache-controller
  behavior have harness coverage; full system paths already report data-cache
...
- Complete CHI-like coherence beyond the current line-state crate and
  single-line cache controller, plus richer cache internals such as additional
  prefetcher algorithms, prefetch translation and snoop integration, QoS,
