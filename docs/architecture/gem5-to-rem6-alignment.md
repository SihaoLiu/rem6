...
global data limit and timing policy, and snapshots the active side cursor. A typed
traffic controller now binds Markov graph states to the implemented idle, exit,
...
memory-controller-coupled DRAM/NVM execution, and transport retry or response
statistics remain open traffic-generator targets.
