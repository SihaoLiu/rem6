...
- CLI tests cover the initial standalone `rem6 run` binary path: RISC-V ELF
  ...
  a CLI error. CLI tests also cover `rem6 trace-replay` executing a gem5 packet
