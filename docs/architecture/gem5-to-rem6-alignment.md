...
- Configuration and experiment reproducibility are too script-dependent in
  ...
  manifests, artifact identities, custom guest-host calls, and explicit boot
  handoff reports as the authority for platform and workload state.
