...
transactional-memory execution exists yet. Broader TLBI execution semantics,
TLBI completion forms, and CPU-visible HTM behavior remain open because they
need CPU/MMU-visible event contracts, and sync flags beyond `KERNEL` need
