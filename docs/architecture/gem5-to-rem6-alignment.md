...
- Full-system RISC-V tests drive multicore fetch, data access, traps, host stop,
  ...
  fetches from a non-first memory target with a different line layout. Workload
