...
- Error surfaces are split across simulator fatal errors, simulator panics, and
  ...
  rejection, trailing bytes, and skipped prefix noise
...
- Debug packet tests cover GDB remote packet checksum encoding and decoding,
  ...
  skipping, legacy sequence-id rejection, bounded payload enforcement,
  acknowledgement, negative acknowledgement, interrupt, and skipped-prefix
  stream parsing before socket or ISA register-cache integration.
