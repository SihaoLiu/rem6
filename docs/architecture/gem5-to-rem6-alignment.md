...
- gem5 cache tags split set selection between SetAssociative and
  ...
  MSI cache banks can now opt into those compressed tags for explicit
  ...
  rollback, snapshot restore, and tag-backend mode mismatch rejection. MESI,
  MOESI, and CHI compressed-tag bank integration remain separate alignment
  targets.
...
- Cache indexing and replacement-directory tests cover gem5-style
  ...
  MSI cache-bank compressed-tag tests cover explicit compressed-size
...
- Complete CHI-like coherence beyond the current line-state crate, single-line
  ...
  and MESI/MOESI/CHI compressed-tag bank integration.
