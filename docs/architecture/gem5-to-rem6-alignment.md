...
- Debug packet tests cover GDB remote packet checksum encoding and decoding,
  ...
  all-register write parsing, all-register write `OK` responses, `p n`
  single-register request parsing, target-order register byte hex response
