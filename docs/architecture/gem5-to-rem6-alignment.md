...
- Error surfaces are split across simulator fatal errors, simulator panics, and
  ...
  packet suppression, `p n` single-register read requests, target-order register-byte
