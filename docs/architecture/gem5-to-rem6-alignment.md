...
- Observability and statistics need stronger contracts. A gem5 issue about
  ...
  registry-owned history, and dump/reset events are also kept in one typed
  interleaved history. Counter paths are structured scope/name identities with
  a checked dot-separated spelling before registration, registry-owned stat
