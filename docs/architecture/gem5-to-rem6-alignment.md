...
gem5 response read/write classification, data policy, invalidation policy, and
clean policy, plus packet-count accounting without constructing a
`MemoryRequest` or adding read/write byte accounting.
