...
CPU fetch initiation, multicore CPU cluster validation, RV64I decode and
architectural execution, interrupts, MMIO, timers, UART devices, platform
assembly, memory transactions and storage, transport, fabric timing, DRAM timing,
